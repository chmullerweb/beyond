<template>
  <div class="">
    <CardTitle btnHidden>
      <template v-slot:claimTitle>Conditions Générales d'Utilisation - Beyond</template>
    ...
    <h2 class="margin-t-2">Article 3 : Accès au site</h2>
     <p>
    ...
    <h2 class="margin-t-2">Article 4 : Collecte des données</h2>
     <p>
    ...
    <h2 class="margin-t-2">Article 5 : Propriété intellectuelle</h2>
     <p>
      ...
      <h2 class="margin-t-2">Article 6 : Responsabilité</h2>
      <p>
        Bien que les informations publiées sur le site soient réputées fiables, le site se réserve la faculté d’une non-garantie de la fiabilité des sources.
      </p>
      <p>
      ...
      <h2 class="margin-t-2">Article 7 : Liens hypertextes</h2>
      <p>
      ...
      <h2 class="margin-t-2">Article 8 : Cookies</h2>
      <p>
      ...
      <h2 class="margin-t-2">Article 9 : Publication par l’Utilisateur</h2>
      <p>
      ...
      <h2 class="margin-t-2">Article 11 : Durée du contrat</h2>
      <p>
      ...
      <h2 class="margin-t-2">Article 12 : Droit applicable et juridiction compétente</h2>
      <p>
