<template>
  <div class="modal_fixed container-fluid">
    ...
    >
      <h2 class="contactUs">
        Contactez-nous !<i
          class="fas fa-times-circle i_cross bounceIn"
      ...
      <div class="form-group">
        <div class="form-check">
          ...
          <label class="form-check-label" for="gridCheck">
            J'accepte que ces informations soient traitées dans le cadre de ma
            demande.
          </label>
        </div>
      </div>
...
export default {
  ...
  methods: {
    checkForm(e) {
      ...
      if (!this.inputPhone) {
        this.errors.push(
          "N'oubliez pas votre numéro de téléphone pour vous recontacter"
        );
      }
